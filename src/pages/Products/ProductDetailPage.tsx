...
const ProductDetailPage = () => {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#0f321b] text-white">
      ...
      <div className="relative">
        ...
        <section className="mx-auto max-w-7xl px-4 pb-20 pt-8 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid items-center gap-8 lg:grid-cols-[1.02fr_0.98fr]">
            <div>
              <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#FBC719]/70 bg-[#FBC719]/12 px-4 py-2 text-sm font-black text-[#FBC719] backdrop-blur-xl">
                <SectionIcon size={17} />
            ...
            <div className="relative">
              <div className="absolute -right-6 -top-6 h-36 w-36 rounded-full border border-[#FBC719]/40 bg-[#FBC719]/18 blur-2xl" />
              <div className="relative overflow-hidden rounded-[28px] border-4 border-white bg-white shadow-[0_34px_90px_rgba(0,0,0,0.36)]">
                <div className="aspect-[1.12/1] overflow-hidden bg-[#123d21]">
                  <img
                    src={product.image}
                    alt={product.name}
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-[0.92fr_1.08fr]">
            <div className="group relative overflow-hidden rounded-[24px] border border-[#FBC719]/34 bg-[#196931]/72 p-6 shadow-[0_24px_70px_rgba(0,0,0,0.22)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-[#FBC719]/80 hover:bg-[#196931]/88 hover:shadow-[0_28px_80px_rgba(0,0,0,0.28)]">
              ...
              <p className="relative mt-4 text-base font-semibold leading-8 text-white/78">
                {product.summary}
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {product.highlights.map((item) => (
                <div
                  key={item}
                  className="group relative overflow-hidden rounded-[22px] border border-white/12 bg-white/[0.08] p-5 shadow-[0_18px_55px_rgba(0,0,0,0.16)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-[#FBC719]/70 hover:bg-[#172c1d]/86 hover:shadow-[0_24px_70px_rgba(0,0,0,0.24)]"
                >
          ...
          <div className="mt-8 flex flex-col gap-3 rounded-[24px] border border-white/12 bg-[#0b2a16]/70 p-5 backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-full bg-[#FBC719] px-6 py-3 text-sm font-black text-[#196931] transition hover:bg-white"
            >
              Maslahat olish
            </button>
          </div>
      ...
      {isContactDialogOpen && (
        <div
          className="fixed inset-0 z-[80] grid place-items-center bg-[#06170d]/74 px-4 backdrop-blur-md"
          role="dialog"
          aria-modal="true"
        ...
        >
          <div
            className="relative w-full max-w-md overflow-hidden rounded-[28px] border border-[#FBC719]/34 bg-[#0b2a16] p-6 text-white shadow-[0_34px_90px_rgba(0,0,0,0.42)]"
          ...
          >
            ...
            <div className="mt-6 grid gap-3">
              <a
                ...
                className="group flex items-center gap-4 rounded-[20px] border border-white/12 bg-white/[0.08] p-4 transition hover:-translate-y-0.5 hover:border-[#FBC719]/70 hover:bg-[#196931]/70"
              >
