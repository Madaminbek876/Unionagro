              ...
              <div className="relative overflow-hidden rounded-[22px] border-4 border-[#FBC719] bg-[#123d21] shadow-[0_34px_90px_rgba(0,0,0,0.36)] sm:rounded-[28px]">
                ...
                >
                  ...
                  {productSlides.length > 1 ? (
                    <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between gap-4 rounded-[18px] border border-white/18 bg-[#415238]/88 px-3 py-2.5 text-white shadow-[0_18px_42px_rgba(0,0,0,0.28)] backdrop-blur-2xl sm:bottom-4 sm:left-5 sm:right-5 sm:gap-3 sm:rounded-[22px] sm:px-5 sm:py-4">
                      <div className="flex min-w-0 items-center gap-1 sm:gap-2">
                        {productSlides.map((slide, index) => (
                          <button
                            ...
                            className={`h-2 shrink-0 rounded-full border border-white/30 transition sm:h-3 ${
                              index === activeProductSlide
                                ? "w-6 bg-[#FBC719] sm:w-8"
                                : "w-2 bg-white/70 sm:w-3"
                            }`}
                          />
                        ))}
                      </div>
                      <div className="shrink-0">
                        <a
                          ...
                          className="inline-flex min-h-8 max-w-[8.6rem] items-center justify-center gap-1 overflow-hidden rounded-full bg-[#FBC719] px-2.5 py-1.5 text-[11px] font-black text-[#172c1d] shadow-[0_14px_34px_rgba(0,0,0,0.28)] transition hover:bg-white sm:min-h-11 sm:max-w-none sm:gap-2 sm:px-5 sm:text-sm"
                        >
