  ...
  return (
    <div className="group mx-auto w-full max-w-[320px] text-center sm:max-w-[260px]">
      <div className="transition duration-500 group-hover:-translate-y-2">
        <div
          className="relative h-[250px] touch-pan-y cursor-grab overflow-hidden rounded-[14px] border-4 border-white bg-white shadow-[0_18px_42px_rgba(0,0,0,0.32)] active:cursor-grabbing sm:h-[268px]"
